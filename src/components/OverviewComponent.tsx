  ...
  return (
    <div  className="w-full mt-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 text-white">
        ...
        <div className="rounded-md py-8 p-3 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% sm:col-span-2">
            ...
            <FaRegMoneyBill1 className="font-bold text-6xl opacity-40 "></FaRegMoneyBill1>
            </div>
            </Link>
        </div>
        ...
        <div className="rounded-md p-3 py-8 bg-gradient-to-r from-purple-500 from-10%  to-blue-300 to-90%">
            <div>
                <p>Total Products</p>
                <Link href="/admin/allProducts" className=" text-base underline font-base">Click here</Link>
